...
public class MealTestData {
    ...
    public static ResultMatcher contentJson(Meal... meals) {
        return content().json(JsonUtil.writeIgnoreProps(List.of(meals), "user"));
    }

    public static ResultMatcher contentJson(Meal meal) {
        return content().json(JsonUtil.writeIgnoreProps(meal, "user"));
    }
}
